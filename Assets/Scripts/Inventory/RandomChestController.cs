...
public class RandomChestController : EntityData
{
    ...
    public override void ProcessClick(CharacterStats playerData) {
        ...
        if (attackCrystal) {
            ...
            uiController.GetComponent<GabTextController>().AddGabToPlay("<B>" + amountGained + "</B><sprite=5>crystals absorbed into the magic ring. Attack is being fortified.");
        ...
        else if (armorCrystal)
        {
            ...
            GameObject uiController = GameObject.FindGameObjectWithTag("DungeonUI");
            uiController.GetComponent<GabTextController>().AddGabToPlay("<B>" + amountGained + "</B><sprite=3>crystals absorbed into the magic ring. Defense is being fortified.");
        ...
        else if (healthCrystal)
        {
            ...
            GameObject uiController = GameObject.FindGameObjectWithTag("DungeonUI");
            uiController.GetComponent<GabTextController>().AddGabToPlay("<B>" + amountGained + "</B><sprite=4>crystals absorbed into the magic ring. Health is being fortified.");
